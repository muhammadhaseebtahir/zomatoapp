...
//   return(
//     <div className="fixed bottom-0 left-0 right-0 p-2 bg-white dark:bg-gray-700 text-black dark:text-gray-300  boredr-t border-gray-300 flex justify-around md:hidden ">
